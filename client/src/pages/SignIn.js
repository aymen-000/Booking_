    ...
    return (
        <div>
            <div className="relative bg-cover bg-center bg-nav_bg text-white py-4">
                ...
                {/* Sign In Form */}
                <div className={open ? "relative  flex items-center justify-center min-h-screen mt-40" : "relative z-20 flex items-center justify-center min-h-screen"}>
                    <div className="bg-black bg-opacity-80 p-8 rounded-lg shadow-lg w-full max-w-md mx-4 lg:mx-8 py-6">
                        ...
                        <form className="space-y-4 mb-5"  onSubmit={submit}>
                            ...
                            <p className="text-center text-sm mt-6">
                                Don't have an account? <Link to="/signup" className="text-[#C49C74] hover:underline">Sign up</Link>
                            </p>
                            {
